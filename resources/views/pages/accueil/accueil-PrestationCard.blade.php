	...
	<div class="card m-2 d-flex align-items-center" style="width: 15rem; height: 18rem;">
		...
		<div class="card-body cardPrestation">
			...
			<a href="{{--{{$cat->link}}--}}" class="btn btn-warning d-flex align-items-center" style="width: 10rem;">En savoir plus</a>
		</div>
	</div>
